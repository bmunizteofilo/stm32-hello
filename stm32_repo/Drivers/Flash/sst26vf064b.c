...
static void sst26vf064b_send_addr(sst26vf064b_t *flash, uint32_t addr) {
...
void sst26vf064b_read(sst26vf064b_t *flash, uint32_t addr, uint8_t *data, size_t len) {
    ...
    sst26vf064b_send_addr(flash, addr);
...
void sst26vf064b_example(void) {
    ...
    sst26vf064b_t flash;
    sst26vf064b_init(&flash, SPI2);
    uint8_t manuf; uint16_t dev;
    sst26vf064b_read_id(&flash, &manuf, &dev);
    uint8_t buf[16];
    const uint8_t msg[16] = "Hello, Flash!\0";
    sst26vf064b_sector_erase(&flash, 0u);
    sst26vf064b_page_program(&flash, 0u, msg, sizeof(msg));
    sst26vf064b_read(&flash, 0u, buf, sizeof(buf));
