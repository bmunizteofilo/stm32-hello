...
static void at25sf041_send_addr(at25sf041_t *flash, uint32_t addr) {
...
void at25sf041_read(at25sf041_t *flash, uint32_t addr, uint8_t *data, size_t len) {
    ...
    at25sf041_send_addr(flash, addr);
...
void at25sf041_example(void) {
    ...
    at25sf041_t flash;
    at25sf041_init(&flash, SPI1);
    uint8_t manuf; uint16_t dev;
    at25sf041_read_id(&flash, &manuf, &dev);
    uint8_t buf[16];
    const uint8_t msg[16] = "Hello, Flash!\0";
    at25sf041_sector_erase(&flash, 0u);
    at25sf041_page_program(&flash, 0u, msg, sizeof(msg));
    at25sf041_read(&flash, 0u, buf, sizeof(buf));
